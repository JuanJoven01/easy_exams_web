...
const CustomFinishButton = ({text, action}) => {
    ...
    return (
        <div    className=" hover:cursor-pointer group relative overflow-hidden rounded-[10px] bg-gray-300 p-[2px] transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:from-blue-500 hover:via-slate-200 hover:to-charlie"
            ...
            <div className="relative rounded-[10px] bg-slate-800 px-2 w-25">
                <button className="w-full hover:cursor-pointer  text-center font-satoshi-bolditalic bg-gradient-to-r from-amber-400 to-red-500 text-transparent bg-clip-text">{text}</button> 
            </div>
        </div>
    )
}
